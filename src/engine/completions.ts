...
const CMDLET_PARAMS: Record<string, string[]> = {
  ...
  "Set-Location": ["-Path"],
  "Format-Table": ["-Property", "-GroupBy", "-AutoSize", "-HideTableHeaders"],
  "Write-Host": ["-ForegroundColor", "-NoNewline", "-Separator"],
  "Write-Output": [],
  "ConvertTo-Json": [],
  ...
  "New-SearchBuilder": ["-Index", "-Path", "-First", "-Skip", "-Last", "-MaxResults", "-OrderBy", "-Strict", "-LatestVersion", "-IncludeMetadata", "-Property", "-FacetOn"],
  "Add-TemplateFilter": ["-Name", "-Id", "-Invert"],
  "Add-FieldContains": ["-Field", "-Value", "-Invert", "-Boost", "-CaseSensitive"],
  "Add-FieldEquals": ["-Field", "-Value", "-Invert", "-Boost", "-CaseSensitive"],
  "Add-DateRangeFilter": ["-Field", "-Last", "-From", "-To", "-Invert"],
  "Add-SearchFilter": ["-Field", "-Filter", "-Value", "-Invert", "-Boost", "-CaseSensitive"],
  "Invoke-Search": [],
  "Get-User": ["-Identity", "-Filter", "-Current", "-Authenticated"],
  "Get-Role": ["-Identity", "-Filter"],
  "Get-RoleMember": ["-Identity"],
  "New-User": ["-Identity", "-Email", "-FullName", "-Password", "-Enabled"],
  "New-Role": ["-Identity", "-Description"],
